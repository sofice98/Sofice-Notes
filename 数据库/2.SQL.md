...
![](http://mdimg.sofice.top/202201111624614.png)
...
![](http://mdimg.sofice.top/202201111624912.png)
...
![](http://mdimg.sofice.top/202201111624538.png)
...
- **字符匹配**
  ...
  ![](http://mdimg.sofice.top/202201111624207.png)
...
![](http://mdimg.sofice.top/202201111624692.png)
...
![img](http://mdimg.sofice.top/202201041325028.png)
...
![](http://mdimg.sofice.top/202201111624645.png)
...
from (
    select *, rank() over (
        partition by university order by gpa
    ) rank_num
    from user_profile
) up
where up.rank_num=1
...
count(if(month(b.date)=8,1,null)), 
count(if(month(b.date)=8 and b.result='right',1,null))
from user_profile a
...
![](http://mdimg.sofice.top/202201111634191.png)
